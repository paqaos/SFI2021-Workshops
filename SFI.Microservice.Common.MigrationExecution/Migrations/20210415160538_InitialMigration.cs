        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SpeakersId = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventItemUser", x => new { x.SessionsId, x.SpeakersId });
                    table.ForeignKey(
                        name: "FK_EventItemUser_Events_SessionsId",
                        column: x => x.SessionsId,
                        principalTable: "Events",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EventItemUser_Users_SpeakersId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventItemUser_SpeakersId",
                table: "EventItemUser",
                column: "SpeakersId");
